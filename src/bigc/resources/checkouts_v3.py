...
class BigCommerceCheckoutsV3API:
    ...
    def get(
        ...
        *,
        ...
        return self._api.get(
            f'/checkouts/{checkout_id}', params=params, timeout=timeout, retries=retries
        )
    ...
    def add_billing_address(
        ...
        *,
        ...
        return self._api.post(
            f'/checkouts/{checkout_id}/billing-address',
            data=data,
            params=params,
            timeout=timeout,
        )
    ...
    def update_billing_address(
        ...
        *,
        ...
        return self._api.put(
            f'/checkouts/{checkout_id}/billing-address/{address_id}',
            data=data,
            params=params,
            timeout=timeout,
            retries=retries,
    ...
    def add_consignments(
        ...
        *,
        ...
        return self._api.post(
            f'/checkouts/{checkout_id}/consignments',
            data=data,
            params=params,
            timeout=timeout,
        )
    ...
    def update_consignment(
        ...
        *,
        ...
        return self._api.put(
            f'/checkouts/{checkout_id}/consignments/{consignment_id}',
            data=data,
            params=params,
            timeout=timeout,
            retries=retries,
    ...
    def add_coupon(
        ...
        *,
        ...
        return self._api.post(
            f'/checkouts/{checkout_id}/coupons',
            data=data,
            params=params,
            timeout=timeout,
        )
    ...
    def delete_coupon(
        ...
        *,
        ...
        return self._api.delete(
            f'/checkouts/{checkout_id}/coupons/{coupon_code}',
            params=params,
            timeout=timeout,
            retries=retries,
        )
    ...
    def add_discounts(
        ...
        *,
        ...
        return self._api.post(
            f'/checkouts/{checkout_id}/discounts',
            data=data,
            params=params,
            timeout=timeout,
        )
    ...
    def create_order(
        ...
        *,
        ...
        """Create an order"""
        return self._api.post(
            f'/checkouts/{checkout_id}/orders', params=params, timeout=timeout
        )

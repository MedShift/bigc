...
class BigCommerceCustomersV3API:
    ...
    def all(
        ...
        *,
        ...
        return self._api.get_many(
            '/customers', params=params, timeout=timeout, retries=retries, cursor=True
        )
        ...
        *,
        ...
        try:
            return self._api.get(
                '/customers', params=params, timeout=timeout, retries=retries
            )[0]
        except IndexError:
            raise DoesNotExistError() from None

    def create_many(
        self, data: list[dict[str, Any]], *, timeout: float | None = None
    ) -> list[dict[str, Any]]:
        """Create many customers"""
        return self._api.post('/customers', data=data, timeout=timeout)

    def create(
        self, data: dict[str, Any], *, timeout: float | None = None
    ) -> dict[str, Any]:
    ...
    def delete_many(
        ...
        *,
        ...
        self._api.delete('/customers', params=params, timeout=timeout, retries=retries)
    ...
    def update_form_fields(
        ...
        *,
        ...
        return self._api.put(
            '/customers/form-field-values', data=data, timeout=timeout, retries=retries
        )
    ...
    def update_form_field(
        ...
        *,
        ...
        return self.update_form_fields(
            [{'customer_id': customer_id, **data}], timeout=timeout, retries=retries
        )[0]
    ...
    def all_addresses(
        ...
        *,
        ...
        return self._api.get_many(
            '/customers/addresses', params=params, timeout=timeout, retries=retries
        )
    ...
    def update_addresses(
        ...
        *,
        ...
        return self._api.put(
            '/customers/addresses', data=data, timeout=timeout, retries=retries
        )
    ...
    def update_address(
        ...
        *,
        ...
        try:
            return self.update_addresses(
                [{'id': address_id, **data}], timeout=timeout, retries=retries
            )[0]
        except IndexError:
            raise InvalidDataError('This address already exists.') from None

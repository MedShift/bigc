...
class BigCommerceCartsAPI:
    ...
    def get(self, cart_id: UUIDLike, *, params: dict[str, Any] | None = None, timeout: float | None = None) -> dict[str, Any]:
    ...
    def create_redirect_url(self, cart_id: UUIDLike, *, params: dict[str, Any] | None = None, timeout: float | None = None) -> dict[str, Any]:

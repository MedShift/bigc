...
class TestParseRfc2822Date:
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                'Sun, 20 Jul 1969 20:17:40 +0000',
                datetime(1969, 7, 20, 20, 17, 40, tzinfo=TZ_UTC),
            ),
            (
                'Tue, 05 Mar 2019 21:40:11 +0000',
                datetime(2019, 3, 5, 21, 40, 11, tzinfo=TZ_UTC),
            ),
        ],
    )
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                'Sat, 01 Jan 2000 0:00:00 -0400',
                datetime(2000, 1, 1, tzinfo=timezone(-timedelta(hours=4))),
            ),
            (
                'Sat, 01 Jan 2000 0:00:00 +0900',
                datetime(2000, 1, 1, tzinfo=timezone(timedelta(hours=9))),
            ),
        ],
    )
